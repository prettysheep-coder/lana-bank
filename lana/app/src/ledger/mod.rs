...
impl Ledger {
    ...
    #[instrument(name = "ledger.get_bank_deposits_balance", skip(self), err)]
    ...
    #[instrument(name = "ledger.get_customer_balance", skip(self), err)]
    ...
    #[instrument(
        name = "ledger.create_unallocated_collateral_account_for_customer",
        skip(self),
        err
    )]
    ...
    #[instrument(name = "ledger.add_equity", skip(self), err)]
    ...
    #[instrument(name = "ledger.record_deposit_for_customer", skip(self), err)]
    ...
    #[instrument(name = "ledger.initiate_withdrawal_for_customer", skip(self), err)]
    ...
    #[instrument(name = "ledger.confirm_withdrawal_for_customer", skip(self), err)]
    ...
    #[instrument(name = "ledger.cancel_withdrawal_for_customer", skip(self), err)]
    ...
    #[instrument(name = "ledger.credit_facility_balance", skip(self), err)]
    ...
    #[instrument(
        name = "ledger.record_credit_facility_interest_incurrence",
        skip(self),
        err
    )]
    ...
    #[instrument(name = "ledger.activate_credit_facility", skip(self), err)]
    ...
    #[instrument(
        name = "ledger.record_credit_facility_interest_accrual",
        skip(self),
        err
    )]
    ...
    #[instrument(name = "ledger.record_disbursal", skip(self), err)]
    ...
    #[instrument(name = "ledger.manage_credit_facility_collateral", skip(self), err)]
    ...
    #[instrument(name = "ledger.record_credit_facility_repayment", skip(self), err)]
    ...
    #[instrument(name = "ledger.complete_credit_facility", skip(self), err)]
    ...
    #[instrument(name = "ledger.create_accounts_for_credit_facility", skip(self), err)]
