...
export const mockMutation = (overrides?: Partial<Mutation>, _relationshipsToOmit: Set<string> = new Set()): { __typename: 'Mutation' } & Mutation => {
    ...
    return {
        ...
        depositModuleConfigure: overrides && overrides.hasOwnProperty('depositModuleConfigure') ? overrides.depositModuleConfigure! : relationshipsToOmit.has('DepositModuleConfigUpdatePayload') ? {} as DepositModuleConfigUpdatePayload : mockDepositModuleConfigUpdatePayload({}, relationshipsToOmit),
