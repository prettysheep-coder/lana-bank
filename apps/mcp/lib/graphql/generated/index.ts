...
export type ApprovalProcessTarget =
  | CreditFacility
...
export type CreditFacilityHistoryEntry =
...
export type DepositAccountHistoryEntry =
...
export function useExampleQuerySuspenseQuery(
  ...
  return Apollo.useSuspenseQuery<ExampleQueryQuery, ExampleQueryQueryVariables>(
    ExampleQueryDocument,
    options
  );
}
