...
sigma_to_event_frequency as (
    select 1 as sigma_level, 100.00 as normal_frequency_per_year, 90.0 as laplace_frequency_per_year union all
    select 2 as sigma_level, 20.000 as normal_frequency_per_year, 20.0 as laplace_frequency_per_year union all
    select 3 as sigma_level, 1.0000 as normal_frequency_per_year, 5.00 as laplace_frequency_per_year union all
    select 4 as sigma_level, 0.0200 as normal_frequency_per_year, 1.00 as laplace_frequency_per_year union all
    select 5 as sigma_level, 0.0002 as normal_frequency_per_year, 0.30 as laplace_frequency_per_year union all
    select 6 as sigma_level, 7e-007 as normal_frequency_per_year, 0.08 as laplace_frequency_per_year union all
    select 7 as sigma_level, 9e-010 as normal_frequency_per_year, 0.02 as laplace_frequency_per_year
),
