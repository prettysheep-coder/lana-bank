...
pub(super) const PENALTY_REVENUE_ACCOUNT_SET_ID: Uuid =
    uuid!("00000000-0000-0000-0000-500000000003");
...
pub(super) const PENALTY_REVENUE_CONTROL_ACCOUNT_SET_ID: Uuid =
    uuid!("00000000-0000-0000-0000-110000000008");
